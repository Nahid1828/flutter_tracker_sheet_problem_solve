...
class _SwipeableListScreenState extends State<SwipeableListScreen> {
  ...
  void _editItem(int index) {
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Edit pressed on ${items[index]}')));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 52, 139, 64),
      ),
              ...
              endActionPane: ActionPane(
                ...
                children: [
                  SlidableAction(
                    ...
                    backgroundColor: const Color.fromARGB(255, 23, 140, 118),
                    icon: Icons.edit,
                    label: 'Edit',
                  ),
                  SlidableAction(
